...
def order_list(request):
    ...
    # pagination
    paginator = Paginator(order, 10)  # Show 15 contacts per page
    page = request.GET.get('page')
    try:
...
def newcar(request):
    ...
    # pagination
    paginator = Paginator(new, 10)  # Show 15 contacts per page
    page = request.GET.get('page')
    try:
...
def admin_car_list(request):
    ...
    # pagination
    paginator = Paginator(car, 10)  # Show 15 contacts per page
    page = request.GET.get('page')
    try:
        car = paginator.page(page)
    except PageNotAnInteger:
